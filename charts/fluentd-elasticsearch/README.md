...
helm install kube-logging kiwigrid/fluentd-elasticsearch --values values.yaml
```
...
```console
$ helm install kube-logging kiwigrid/fluentd-elasticsearch --set elasticsearch.host=ES_HOST
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart. For example,

```console
$ helm install kube-logging -f values.yaml kiwigrid/fluentd-elasticsearch
```
